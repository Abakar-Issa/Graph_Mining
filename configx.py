...
class ConfigX(object):
    ...
    def __init__(self):
        ...
        #Dataset Parameters
        self.dataset_name = "delicious"  # short name of datasets ["ft":"filmtrust","db":"douban","ca":"ciao"]
        ...
        self.maxIter = 10  # the maximum number of iterations
        ...
        self.model_path = "../results/model/"  # the directory of well-trained variables
        self.result_log_path = "../results/log/"  # the directory of logs when training models
